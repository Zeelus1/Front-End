// Arquivo: src/components/termosdeUso/TermosDeUsoModal.jsx (COM BOTÃO DENTRO DO CORPO)
  ...
  return (
    <div className={Style.modalOverlay}>
      <div className={Style.modalContent}>
        ...
        {/* A caixa de texto branca agora contém TUDO: o texto e o botão */}
        <div className={Style.modalBody}>

          {/* Criei um container para o texto para garantir que o scroll funcione bem */}
          ...
          {/* ALTERADO: O botão "Aceito" agora está aqui, dentro de seu próprio container para alinhamento. */}
        ...
        {/* O modalFooter antigo não é mais necessário */}
