      ...
      <div className={`${Style.menu_mobile} ${isMenuOpen ? Style.active : ""}`}>
        ...
        <nav className={Style.nav_mobile}>
          <ul>
            ...
            <li>
              <Link to="/home/calendario" onClick={toggleMenu}>
                Calendário
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/home/forum" onClick={toggleMenu}>
                Fórum
              </Link>
            </li>
            <li>
      ...
      <nav className={Style.nav_desktop}>
        <ul>
          ...
          <li className={Style.liLink}>
            <Link
              to="/home/registros"
              className={activeLink === "registros" ? Style.active : ""}
            >
              Registros
            </Link>
          </li>
          <li className={Style.liLink}>
            <Link
              to="/home/forum"
              className={activeLink === "forum" ? Style.active : ""}
            >
              Fórum
            </Link>
          </li>
          ...
          <li>
            <Link to="" title="Notificações">
              <div>
                <img
                  src={SinoIcon}
                  alt="Ícone de Sino para representar botão de notificação"
                />
              </div>
            </Link>
          </li>
          <li>
            <Link to="/home/perfil" title="Perfil">
              <div
                className={Style.avatar}
                style={{ backgroundImage: `url(${avatarGabriela})` }}
              ></div>
            </Link>
          </li>
        </ul>
